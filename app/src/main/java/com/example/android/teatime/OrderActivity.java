...
public class OrderActivity extends AppCompatActivity {
    ...
    private static final String TEA_SIZE_SMALL = "Small (R5/cup)";
    private static final String TEA_SIZE_MEDIUM = "Medium (R6/cup)";
    private static final String TEA_SIZE_LARGE = "Large (R7/cup)";
